// pages/pengaturan/dasaraturan.js
// Submenu "Dasar Aturan" (dulu berada langsung di /pengaturan).
// Berisi Menimbang (a & b) + Dasar aturan (global admin + pribadi user).
import Head from 'next/head';
import { useSession } from 'next-auth/react';
import DashboardLayout from '../../components/DashboardLayout';
import ContainerPengaturan from '../../components/pengaturan/ContainerPengaturan';

export default function DasarAturanPage() {
